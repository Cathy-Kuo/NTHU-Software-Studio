...
function notifyMe() {
    if (Notification.permission !== "granted")
      ...
      var notification = new Notification('New Post!', {
        icon: 'icon.png',
        body: "Come and see the new post!",
      });
  
      notification.onclick = function () {
        window.open("https://forum-758ac.firebaseapp.com");      
      };
...
// user page, post page, post list page(cater), leave comment under any post ,Add Chrome notification(5)
//Use CSS animation(2.5), Prove your website has strong security(5),Other functions not mentioned above(10)